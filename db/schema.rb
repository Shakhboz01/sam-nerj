...
ActiveRecord::Schema[7.0].define(version: 2025_01_06_051144) do
  ...
  create_table "packs", force: :cascade do |t|
    ...
    t.string "code"
    t.string "barcode"
    t.decimal "initial_remaining", precision: 17, scale: 2, default: "0.0"
  ...
  create_table "product_sells", force: :cascade do |t|
    ...
    t.decimal "number_of_sizes", precision: 10, scale: 2
    t.boolean "danger_zone"
  ...
  create_table "salaries", force: :cascade do |t|
    ...
    t.date "month", default: "2025-01-06"
    t.bigint "team_id"
    t.bigint "user_id"
